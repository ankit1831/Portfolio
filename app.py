...
4. ALWAYS USE BULLET POINTS: You MUST structure your answers using bullet points (•). NEVER write in plain blocks of text or paragraphs.However, for simple greetings, "missing info" apologies, or single-sentence answers, write normally WITHOUT bullet points.
