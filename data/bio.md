...
### AI Research Intern — CodingJr (Remote) | Apr 28, 2025 – Jul 28, 2025

- Researched generative AI and transformer models
- Developed chatbot solutions using NLP techniques
- Implemented fine-tuning and evaluation pipelines
- Exposure to production AI deployment practices
- Collaborated remotely with engineering teams across India
...
- House Captain (School leadership): led and coordinated student activities/events
- Sports: Kho Kho (cluster-level multiple times, regional participation), cricket enthusiast
